//I have no idea how this works. Ask Guido Dipietro for documentation
class Cube {
    constructor(){
        this.state = {
...
function simplifyManeuver(scramble){
...
export function isSolved(scramble, solution){
    ...
    let output;
    if(!parsedSolution.includes("error") && statesAreEqual(cube.state, solvedCube.state)){
